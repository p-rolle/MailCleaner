...
public function getSpeciticReplace($template, $form) {
  $ret = array(
	 ...
	 "__FORM_INPUTUSESPF__" => $form->checkbox('use_spf', 1, $this->getPref('use_spf'), '', 1),
         "__FORM_INPUTUSESPF_BF__" => $form->checkbox('use_spf_bf', 1, $this->getPref('use_spf_bf'), '', 1),
         "__FORM_INPUTUSESPF_RT__" => $form->checkbox('use_spf_rt', 1, $this->getPref('use_spf_rt'), '', 1),
	 ...
	 "__FORM_INPUTSPFTIMEOUT__" => $form->input('spf_timeout', 4, $this->getPref('spf_timeout')),
         "__FORM_INPUTSPFTIMEOUT_BF__" => $form->input('spf_timeout_bf', 4, $this->getPref('spf_timeout_bf')),
         "__FORM_INPUTSPFTIMEOUT_RT__" => $form->input('spf_timeout_rt', 4, $this->getPref('spf_timeout_rt')),
